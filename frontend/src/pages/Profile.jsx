...
function Profile() {
  ...
  return (
    <div className="mx-auto max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
      {/* Profile header card */}
      <div className="mx-auto max-w-md rounded-xl bg-white p-8 text-center shadow-soft border border-gray-100">
        ...
        <h1 className="mt-4 text-lg font-bold text-text">{user.name}</h1>
        ...
        <button
          ...
          className="mt-6 inline-flex items-center gap-2 rounded-xl bg-primary px-5 py-2 text-xs font-semibold text-white transition-colors hover:bg-[#c42f3b]"
        >
      ...
      <div className="mt-12">
        <h2 className="mb-6 flex items-center gap-2 text-lg font-bold text-text">
          <FaHeart className="text-primary text-sm" /> Favorite Restaurants
        </h2>
