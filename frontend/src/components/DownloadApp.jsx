      ...
      <div className="mx-auto grid max-w-7xl items-center gap-10 px-4 sm:px-6 lg:grid-cols-2 lg:px-8">
        ...
        <div>
          ...
          <div className="mt-8 flex flex-wrap gap-3">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="flex items-center gap-3 rounded-xl bg-text px-5 py-3 text-white transition-colors hover:bg-gray-800"
            >
        ...
        <div className="flex justify-center">
          <img
            ...
            alt="Food Zone app on phone"
            className="max-h-80 rounded-xl object-cover shadow-card"
          />
        </div>
      </div>
    </section>
